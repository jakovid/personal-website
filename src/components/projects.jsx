            ...
            <div className="my-projects-items">
                ...
                <div className="my-project-item reverse">
                    ...
                    <div className="my-project-item-info reverse">
                        ...
                        <p>Set Listed is a social media web application for live performers I am working on with two developers in the UK through Trello and Github. The project incorporates RESTful APIs, CRUD operations, state management, and asynchronus programming. Users can currently create and update profiles, and create posts. In the future they will be able to send messages, create groups, and share events.</p>
                        <div className="my-project-item-skills">
                            <div className="skill-icon">
                                <p>TypeScript</p>
                                <IconContext.Provider value={{ size: "3rem"}}>
